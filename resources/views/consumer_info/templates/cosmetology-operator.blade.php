...
<head>
    ...
    <style type="text/css">
		...
		.question-icon
		{
		    ...
		    height:8px;
		    margin-top:3px;
		    background-image:url({!! asset('/images/consumer_info_images') !!}/icon_q.png);
		...
		.answer-icon
		{
		    ...
		    height:8px;
		    margin-top:3px;
		    background-image:url({!! asset('/images/consumer_info_images') !!}/icon_a.png);
		    background-repeat:no-repeat;
		}
		...
		.divider
		{
		    background-image: url({!! asset('/images/consumer_info_images') !!}/dotdivider.gif);
		...
		{
		    background-image:url({!! asset('/images/consumer_info_images') !!}/icon_question.png); 
		    background-repeat:no-repeat; 
	...
	<script type="text/javascript">
        ...
        var dict = [];
        dict['4125074f-a19e-421f-abaa-ae3be0dd9b9b'] = {};
dict['4125074f-a19e-421f-abaa-ae3be0dd9b9b'].opeId='021122';
dict['4125074f-a19e-421f-abaa-ae3be0dd9b9b'].schoolName='Great Lakes Institute of Technology';
dict['4125074f-a19e-421f-abaa-ae3be0dd9b9b'].currentYear='2014';
dict['4125074f-a19e-421f-abaa-ae3be0dd9b9b'].prevYear='2013';
dict['4125074f-a19e-421f-abaa-ae3be0dd9b9b'].programName='Cosmetology/Cosmetologist, General';
dict['4125074f-a19e-421f-abaa-ae3be0dd9b9b'].customProgramName='Cosmetology Operator';
dict['4125074f-a19e-421f-abaa-ae3be0dd9b9b'].cipCode='12.0401';
dict['4125074f-a19e-421f-abaa-ae3be0dd9b9b'].awardLevel='Undergraduate certificate';
dict['4125074f-a19e-421f-abaa-ae3be0dd9b9b'].tutionAndFees='16500';
dict['4125074f-a19e-421f-abaa-ae3be0dd9b9b'].booksAndSupplies='2100';
dict['4125074f-a19e-421f-abaa-ae3be0dd9b9b'].roomAndBoard='0';
dict['4125074f-a19e-421f-abaa-ae3be0dd9b9b'].roomAndBoardNotOffered=true;
dict['4125074f-a19e-421f-abaa-ae3be0dd9b9b'].additionalFeeAndExpenses='No additional information provided.';
dict['4125074f-a19e-421f-abaa-ae3be0dd9b9b'].urlForProgramCost='http://www.glit.edu/disclosures';
dict['4125074f-a19e-421f-abaa-ae3be0dd9b9b'].numberOfStudentsCompletedProgram='67';
dict['4125074f-a19e-421f-abaa-ae3be0dd9b9b'].numberOfStudentsCompletedProgramWithDebt='0';
dict['4125074f-a19e-421f-abaa-ae3be0dd9b9b'].isLessThanTenGraduatesReceivedLoan=false;
dict['4125074f-a19e-421f-abaa-ae3be0dd9b9b'].title4MedianDebt='12111';
dict['4125074f-a19e-421f-abaa-ae3be0dd9b9b'].privateMedianDebt='0';
dict['4125074f-a19e-421f-abaa-ae3be0dd9b9b'].financingPlanDebt='0';
dict['4125074f-a19e-421f-abaa-ae3be0dd9b9b'].normalTimeToCompleteProgram='36';
dict['4125074f-a19e-421f-abaa-ae3be0dd9b9b'].durationTypeInWeeksMonthsYears='weeks';
dict['4125074f-a19e-421f-abaa-ae3be0dd9b9b'].numberOfStudentsCompletedProgramInNormalTime='37';
dict['4125074f-a19e-421f-abaa-ae3be0dd9b9b'].jobPlacementRateNotRequired=false;
dict['4125074f-a19e-421f-abaa-ae3be0dd9b9b'].jobPlacementRateIsPrivate=false;
dict['4125074f-a19e-421f-abaa-ae3be0dd9b9b'].jobPlacementRateNoGrads=false;
dict['4125074f-a19e-421f-abaa-ae3be0dd9b9b'].reportedToAgency=true;
dict['4125074f-a19e-421f-abaa-ae3be0dd9b9b'].jobPlacementRateForAgency='82';
dict['4125074f-a19e-421f-abaa-ae3be0dd9b9b'].agencyToReport='ACCSC';
dict['4125074f-a19e-421f-abaa-ae3be0dd9b9b'].completedStudentsIncludedForAgency='Graduates who began training 3/2013-2/2014';
dict['4125074f-a19e-421f-abaa-ae3be0dd9b9b'].jobTypesForAgency='fieldrelated';
dict['4125074f-a19e-421f-abaa-ae3be0dd9b9b'].positionsRecentCompletersHiredForAgency='Stylist, Manicurist, Hairdresser';
dict['4125074f-a19e-421f-abaa-ae3be0dd9b9b'].formerStudentsEmploymentTimeForAgency='Program completers who were employed within 1 year of the maximum timeframe to completion.';
dict['4125074f-a19e-421f-abaa-ae3be0dd9b9b'].trackingMethodForAgency='3';
dict['4125074f-a19e-421f-abaa-ae3be0dd9b9b'].trackingValueForAgency='Career Services Office';
dict['4125074f-a19e-421f-abaa-ae3be0dd9b9b'].additionalNotes='No additional information provided.';
dict['4125074f-a19e-421f-abaa-ae3be0dd9b9b'].dateCreated='9/30/2015';
dict['4125074f-a19e-421f-abaa-ae3be0dd9b9b'].relatedOccupations=[];
dict['4125074f-a19e-421f-abaa-ae3be0dd9b9b'].relatedOccupations.push({ oneTitle: 'Hairdressers, Hairstylists, and Cosmetologists', oneCode: '39-5012.00' });
dict['4125074f-a19e-421f-abaa-ae3be0dd9b9b'].relatedOccupations.push({ oneTitle: 'Makeup Artists, Theatrical and Performance', oneCode: '39-5091.00' });
dict['4125074f-a19e-421f-abaa-ae3be0dd9b9b'].relatedOccupations.push({ oneTitle: 'Manicurists and Pedicurists', oneCode: '39-5092.00' });
dict['4125074f-a19e-421f-abaa-ae3be0dd9b9b'].relatedOccupations.push({ oneTitle: 'Skincare Specialists', oneCode: '39-5094.00' });
dict['4125074f-a19e-421f-abaa-ae3be0dd9b9b'].otherInstitutions=[];
	...
	<div style="width:814px; margin-left:auto; margin-right:auto;padding-left:0px; padding-right:0px;">
		...
		<div style="position:relative; z-index:710;">
			<div id="divPopUpContainer" style="display:none; position:absolute; left:130px; top:200px; z-index:710;">
				<div style="background-image:url({!! asset('/images/consumer_info_images') !!}/popup_top.png); width:532px; height:27px;"></div>
				<div style="background-image:url({!! asset('/images/consumer_info_images') !!}/popup_repeater.png); background-repeat:repeat-y; width:532px;">
					...
					<div class="popup-close" style="float:right; margin-right:32px;"><a href="javascript:closePopUp()"><img src="{!! asset('/images/consumer_info_images') !!}/popup_close.gif" alt="Close" title="Close" style="border-width:0px;" /></a></div>
					<div style="clear:both;"></div>
					<div id="divDotDivider" style="width:532px; margin-top:10px; margin-bottom:5px;"><img src="{!! asset('/images/consumer_info_images') !!}/popup_dotdivider.png" alt="" title=""/> </div>
				...
				<div style="background-image:url({!! asset('/images/consumer_info_images') !!}/popup_bottom.png); width:532px; height:34px;"></div>			
			</div>
		</div>
		<!--pop up ended-->
		...
		<div style="background-image:url({!! asset('/images/consumer_info_images') !!}/bg_top.png); background-repeat:no-repeat; width:816px; height:140px;">
		...
		<div style="background-image:url({!! asset('/images/consumer_info_images') !!}/output_bg_repeater.gif); background-repeat:repeat-y; width:814px;">
			...
			<div style="padding:15px 30px 10px 35px;">
				...
				<div style="float:left; width:350px;">
					<!-- Cost box -->
					<div style="width:345px;height:18px; background-image:url({!! asset('/images/consumer_info_images') !!}/info_box_top.gif); background-repeat:no-repeat;"></div>
					<div style="width:345px; background-image:url({!! asset('/images/consumer_info_images') !!}/info_box_repeater.gif); background-repeat:repeat-y; position:relative;">
						<div style="position:absolute; top:0px; left:8px;"><img src="{!! asset('/images/consumer_info_images') !!}/title_cost.gif" alt="Cost" title="Cost" /></div>
					...
					<div style="width:345px;height:18px; background-image:url({!! asset('/images/consumer_info_images') !!}/info_box_bottom.gif); background-repeat:no-repeat;"></div>
					<!-- end of Cost box -->
					...
					<div style="width:345px;height:18px; background-image:url({!! asset('/images/consumer_info_images') !!}/info_box_top.gif); background-repeat:no-repeat;"></div>
					<div style="width:345px; background-image:url({!! asset('/images/consumer_info_images') !!}/info_box_repeater.gif); background-repeat:repeat-y; position:relative;">
						<div style="position:absolute; top:0px; left:8px;"><img src="{!! asset('/images/consumer_info_images') !!}/title_financing.gif" alt="Financing" title="Financing" /></div>
						<div style="margin-left:42px;">
							<div class="question-icon" title="Question"></div>
				...
				<div style="float:left; width:375px; margin-left:22px;">
					<!-- Success box -->
					<div style="width:370px;height:18px; background-image:url({!! asset('/images/consumer_info_images') !!}/info_box_top_long.gif); background-repeat:no-repeat;"></div>
					<div style="width:370px; background-image:url({!! asset('/images/consumer_info_images') !!}/info_box_repeater_long.gif); background-repeat:repeat-y; position:relative;">
						<div style="position:absolute; top:0px; left:8px;"><img src="{!! asset('/images/consumer_info_images') !!}/title_success.gif" alt="Success" title="Success" /></div>
						<div style="margin-left:42px;">
							<div class="question-icon" title="Question"></div>
							...
							<div class="qa-text">
								...
								Of those that completed the program in 2013-2014, <span id="spanPercentOfStudentsCompletedProgramInNormalTime">XX</span>% finished in <span id="span2NormalTimeToCompleteProgram">XX</span> <span id="span2DurationType"> months</span>.
							</div>
							<div style="clear:both;"></div>
							<div id="divTimeToCompleteProgramDivider" class="divider" style="display:none;"></div>
							<div id="divTimeToCompleteProgramNote" class="small-text" style="padding-bottom:15px;display:none;">* Fewer than 10 students completed this program in 2013-14. The number who finished within the normal time has been withheld to preserve the confidentiality of the students.</div>
						</div>
						...
						<div id="divQuestionForJobPlacementRate" style="margin-left:42px; margin-top:22px; display:none;">
							...
							<div style="border:1px solid #f7f7f4;">
                                ...
                                <div id="divResponseRateNoGradsNote" class="small-text" style="display:none; padding-bottom:15px;">* We are required to calculate this information; however, there were no graduates in this program for the year 2013-14.</div>
								
							
							</div>
						</div>
					</div>
					<div style="width:370px;height:18px; background-image:url({!! asset('/images/consumer_info_images') !!}/info_box_bottom_long.gif); background-repeat:no-repeat;"></div>
					<!--end of Success box -->

					<!-- image link to jobs related to program -->
					<div style="margin-top:50px; padding-left:30%;">		
						<a href="javascript:openPopUp('divRelatedJobsToTheProgram', true, 'Jobs related to this program')"><img style="cursor:pointer;border-width:0px;" src="{!! asset('/images/consumer_info_images') !!}/image_memo.png" alt="Click here for more information on jobs related to this program" title="Click here for more information on jobs related to this program" /></a>
					</div>	
		...
		<div style="background-image:url({!! asset('/images/consumer_info_images') !!}/output_bg_bottom.gif); background-repeat:no-repeat; width:814px; height:22px;"></div>
	</div>
	<script type="text/javascript">
		// Call function to display program
		//displayTemplate('guid');
		displayTemplate('4125074f-a19e-421f-abaa-ae3be0dd9b9b');
    </script>    
</body>
</html>